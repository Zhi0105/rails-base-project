...
ActiveRecord::Schema.define(version: 2022_03_11_101442) do
  ...
  create_table "balance_requests", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["trader_id"], name: "index_balance_requests_on_trader_id"
  end
  ...
  add_foreign_key "balance_requests", "traders"
